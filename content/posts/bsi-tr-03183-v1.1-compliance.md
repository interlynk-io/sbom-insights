...
In short: if you are selling software products in the EU or plan to, BSI TR-03183-2 v1.1 is what you need to align with.
...
**SPDX identifiers for licences.** Licence information must use SPDX identifiers. Free-text names like `"Apache License"` are not accepted. It must be `Apache-2.0`.
...
```bash
sbomqs score --profile bsi-v1.1 ../sbomqs/testdata/bsi/cdx/validFullyCompliantBsiV21.cdx16.json

SBOM Quality Score: 10.0/10.0     Grade: A    Components: 2      EngineVersion: 6    File: ../sbomqs/testdata/bsi/cdx/validFullyCompliantBsiV21.cdx16.json
...
- [sbomqs BSI Scoring Support](/posts/sbomqs-scoring-support-for-bsi-1.1-and-bsi-2.0-in-a-summarized-way/)
- [sbomqs GitHub](https://github.com/interlynk-io/sbomqs)
- [Part 1: NTIA Minimum Elements](/posts/ntia-minimum-elements-2021-compliance/)
- [Part 2: FSCT](/posts/fsct/)
