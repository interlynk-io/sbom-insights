...
draft = false
title = "[Interlynk](https://interlynk.io)'s Response to CISA's 2025 SBOM Minimum Elements Request for Comments"
tags = ["SBOM", "CISA", "Compliance", "Software Supply Chain"]
categories = ["Regulations", "Public Comments"]
description = "[Interlynk](https://interlynk.io)'s formal response to CISA's request for public comments on the 2025 Minimum Elements for a Software Bill of Materials (SBOM)"
...
[Interlynk](https://interlynk.io/) would recommend the following additions
...
[Interlynk](https://interlynk.io/) remains committed to supporting the SBOM community through our open-source tools and stands ready to collaborate with CISA and industry stakeholders in refining and implementing these critical standards. We believe that well-crafted minimum elements will accelerate SBOM adoption while delivering meaningful improvements in software supply chain security and transparency.
